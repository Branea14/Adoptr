...
Revision ID: d38eb418724b
Revises: 
Create Date: 2025-03-31 20:18:02.498963
...
def upgrade():
    ...
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('adopterId', sa.Integer(), nullable=False),
    sa.Column('petId', sa.Integer(), nullable=False),
    sa.Column('adoptedAt', sa.DateTime(), nullable=False),
    sa.ForeignKeyConstraint(['adopterId'], ['users.id'], ),
